...
extension PostEditorVC {
    ...
    func showExplanationViewIfNeeded() {
        if !explanationViewShowed {
            view.addExplanationView(id: "how-do-i-get-rewards", title: "How do I get rewards for my posts?", description: "After you publish the post, community members will have 42 hours to like or dislike it. If your post reaches the Top 10 posts of the day, you will be rewarded.", from: actionButton, marginLeft: 54, marginRight: 10, learnMoreLink: "https://commun.com/faq#How%20can%20you%20get%20the%20points?")
